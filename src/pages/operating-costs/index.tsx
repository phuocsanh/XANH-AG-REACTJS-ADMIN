...
const OperatingCostsPage: React.FC = () => {
  ...
  const { data: costsData, isLoading } = useOperatingCosts({
    ...
    limit: pageSize,
    filters: filters,
    search: filters.name // Using name filter as search for now, or keep separate if API supports general search
  });
      ...
      title: (
          <FilterHeader
            ...
            options={[
                ...
                { label: 'Thuốc BVTV', value: 'pesticide' },
                { label: 'Nhân công', value: 'labor' },
                { label: 'Máy móc', value: 'machinery' },
    ...
    },
    {
      ...
      render: (_: any, record: OperatingCost) => (
          <Space direction="vertical" size={0}>
              ...
              {record.rice_crop && <Tag color="cyan">Ruộng: {record.rice_crop.field_name}</Tag>}
          </Space>
      )
    },
    {
