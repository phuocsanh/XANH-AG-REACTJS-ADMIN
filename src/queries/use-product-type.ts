...
export const useCreateProductTypeMutation = () => {
  ...
  return useMutation({
    mutationFn: (productType: ProductTypeRequest) => productTypeService.createProductType(productType),
    onSuccess: () => {
...
export const useUpdateProductTypeMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, productType }: { id: number, productType: ProductTypeRequest }) => 
...
export const useCreateProductSubtypeMutation = () => {
  ...
  return useMutation({
    mutationFn: (productSubtype: ProductSubtypeRequest) => productTypeService.createProductSubtype(productSubtype),
    onSuccess: () => {
...
export const useUpdateProductSubtypeMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, productSubtype }: { id: number, productSubtype: ProductSubtypeRequest }) => 
