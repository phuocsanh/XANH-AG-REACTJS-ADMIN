...
export const useUpdateProductMutation = () => {
  ...
  return useMutation({
    mutationFn: ({ id, product }: { id: number, product: UpdateProductRequest }) => 
...
export const useSearchProducts = (query: string, limit: number = 10, offset: number = 0) => {
  return useQuery({
...
// Hook lọc sản phẩm
export const useFilterProducts = (filters: Record<string, any>) => {
  return useQuery({
